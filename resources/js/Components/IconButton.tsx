...
export default function IconButton({
    ...
    const buttonsVariants = () => {
        ...
        switch (variant) {
            ...
            case 'search': btn = 'shadow border bg-slate-400 text-slate-50 hover:bg-slate-500 focus:ring-slate-600 active:bg-slate-500'; break;
    ...
    return (
        <Link
            ...
            href={href}
            className={
                `inline-flex items-center rounded-md border border-transparent p-2 text-xs font-semibold uppercase tracking-widest transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 ${disabled && 'opacity-25'
